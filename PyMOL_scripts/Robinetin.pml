...
load ../ligands_PDBs\Robinetin.pdb, Robinetin
util.cba(33,"receptor",_self=cmd)
space cmyk
cmd.color_deep("gray80", "receptor", 0)
set cartoon_transparency, 0.8
distance d1, /receptor/1S//LEU`93/HB2, Robinetin/LIG//LIG`1/H6, state=2
...
distance d2, /receptor/1S//GLU`61/OE2, Robinetin/LIG//LIG`1/H8, state=2
...
distance d3, /receptor/1S//ASP`161/HN, Robinetin/LIG//LIG`1/H9, state=2
...
png ../figures\Robinetin.png, 0, 0, -1, ray=1