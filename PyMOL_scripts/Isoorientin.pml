...
load ../ligands_PDBs\Isoorientin.pdb, Isoorientin
util.cba(33,"receptor",_self=cmd)
space cmyk
cmd.color_deep("gray80", "receptor", 0)
set cartoon_transparency, 0.8
distance d1, /receptor/1S//SER`102/HG1, Isoorientin/LIG//LIG`1/H2, state=11
...
distance d2, /receptor/1S//LYS`30/O, Isoorientin/LIG//LIG`1/H7, state=11
...
distance d3, /receptor/1S//GLU`61/OE2, Isoorientin/LIG//LIG`1/H19, state=11
...
distance d4, /receptor/1S//ASP`161/HN, Isoorientin/LIG//LIG`1/H20, state=11
...
png ../figures\Isoorientin.png, 0, 0, -1, ray=1